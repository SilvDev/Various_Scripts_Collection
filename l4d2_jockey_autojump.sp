...
bool g_bCvarAllow, g_bMapStarted, g_bRoundStart;
int g_iCvarBots;
...
public void OnPluginStart()
{
	...
	CreateConVar(						"l4d2_jockey_autojump_version",			PLUGIN_VERSION,	"Jockey Autojump plugin version.", FCVAR_NOTIFY|FCVAR_DONTRECORD);
